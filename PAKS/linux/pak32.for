...
c bocac               
               IF(NMM.EQ.449189.OR.NMM.EQ.449229.OR.NMM.EQ.449273) THEN
               write(3,1241) vreme,TBTH(nlm),NMM,(birthc(nlm,i),i=1,nd)
...
c bocac               
               IF(NMM.EQ.449189.OR.NMM.EQ.449229.OR.NMM.EQ.449273) THEN
               write(3,1240) vreme,TBTH(nlm),NMM,(birthc(nlm,i),i=1,nd),
     1         (UEL(I),I=1,ND),INDBEL(NLM)
 1240          format(' TU',2F6.1,I9,8(1X,3(1PE8.1))/8(1X,3(1PE8.1)),I5)
               ENDIF
C
...
C stampanje napona na mernim mestima za BOCAC
      IF(NAPON.EQ.1) CALL BOCACN(TA,TED,JG,NLM,AU(LCEL),ICVEL,KOR,VREME)
