...
C
        ...
        LMAXAC=LMAXA +NEQ+1
        LID   =LMAXAC+NEQC+1
        WRITE(3,*) 'JEDN,NEQ,NDOD,nwk8,nwk',JEDN,NEQ,NDOD,nwk8,nwk
C
        IF(JPS.GT.1) THEN
...
c         nwk8=19000000000
         ...
         IF(LMAX.GT.MTOT) CALL ERROR(1)
         IROWS=LMAX
         WRITE(*,*) ' Potreban prostor LMAX',LMAX
         WRITE(3,*) ' Potreban prostor LMAX',LMAX
C		CALL IWRR(A(LMAXA),JEDN+1,'MAX0')
        WRITE(3,*) 'pre JEDN,NEQ,NDOD,nwk8,nwk',JEDN,NEQ,NDOD,nwk8,nwk
         CALL ISPAKUJ(A(IROWS),ISK,MAXA8,NWK8,JEDN)
        WRITE(3,*) 'pos JEDN,NEQ,NDOD,nwk8,nwk',JEDN,NEQ,NDOD,nwk8,nwk
         I2=1
         if(imumps.EQ.1) I2=2 
         IROWS=LMAX
