...
C   KOREKCIJA KOORDINATA ZA CILJNE CVOROVE
     ...
     &        TOLPD,NNMIN,TCMAX,NCAA,NPOL,NCTC,NPOLMX,IND,IFLAG,AMETRIC)
       WRITE(3,*)'PRODOR,XL2M',PRODOR, XL2M
       WRITE(3,*)'posle NBROJNN,NNMIN,NCAMIN',NBROJNN,NNMIN,NCAMIN
       WRITE(3,*)'ro,so',R0,S0
      ENDIF
C SNEZA
   16 IOVR=IND
...
c      IF(PRODOR.GT.0.D0)THEN
        IND=0
C        GO TO 20
       WRITE(3,*)'izlaz IND, prodor',IND,PRODOR
       IK (NLM)=0
       IK1(NLM)=0
       RETURN
      ENDIF
       WRITE(3,*)'IND, prodor',IND,PRODOR
C
...
C      IF(PRODOR.GT.0.D0) IND=0
      WRITE(3,*)'93 - IND,PRODOR',IND,PRODOR
      ENDIF
      RETURN
      END      
C=======================================================================
